#!/system/bin/sh
# Block ROM-level Play Integrity spoof engines.  — TieJia v2.0.0
#
...
#
# Opt-out:  config_get daemon_rom_cleanup returns 0 (unified config)
...
config_get_bool daemon_rom_cleanup || exit 0
